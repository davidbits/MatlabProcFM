...
oRCF.readFromFile(filename, (t_start+1)*Fs, t_length * Fs); % +1 to t_start as RCF class is 1-indexed
...
hdf5write('../Waveforms/txWaveFormNormalised.h5', '/I/value', real(ref), '/Q/value', imag(ref));
fprintf('Complete.\n');
